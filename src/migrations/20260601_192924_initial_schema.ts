...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "profiles" (
  	...
  	"location" varchar,
  	"lead" varchar,
  	"status_label" varchar DEFAULT 'Currently building',
  	"status_text" varchar,
  ...
  ALTER TABLE "projects" ADD CONSTRAINT "projects_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "credentials" ADD CONSTRAINT "credentials_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "stack_groups" ADD CONSTRAINT "stack_groups_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "credentials_user_idx" ON "credentials" USING btree ("user_id");
  ...
  CREATE INDEX "stack_groups_user_idx" ON "stack_groups" USING btree ("user_id");
